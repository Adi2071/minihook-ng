...
void *COffsets::FireBullets(void)
{
	UCHAR Sig[] = "\xB8\xFF\xFF\xFF\xFF\x53\x8B\x9C\x24\xFF\xFF\xFF\xFF\x89\x44\x24\xFF\x89\x44\x24\xFF\x89\x44\x24\xFF\x8B\x84\x24\xFF\xFF\xFF\xFF\xC7\x44\x24\xFF\xFF\xFF\xFF\xFF\x89\x44\x24\xFF\x8D\x43\xFF\x83\xF8\xFF";
	return (void*)(FindMemoryClone(ClBase, ClBase+ClSize, Sig, sizeof(Sig)-1) - 0x06);
}

void **COffsets::RootPanel(void)
{
	UCHAR Sig[] = "\xFF\x15\xFF\xFF\xFF\xFF\xA1\xFF\xFF\xFF\xFF\xC3\x90\x90\x90\x90\x51";
	return (void**)*(DWORD*)(FindMemoryClone(HwBase, HwBase+HwSize, Sig, sizeof(Sig)-1) + 0x07);
}
